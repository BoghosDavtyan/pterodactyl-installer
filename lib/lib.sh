...
# Versioning
export GITHUB_SOURCE=${GITHUB_SOURCE:}
export SCRIPT_RELEASE=${SCRIPT_RELEASE:}
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/BoghosDavtyan/pterodactyl-installer"}
