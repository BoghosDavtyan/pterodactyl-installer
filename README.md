...
For help and support regarding the script itlf and **not the official Pterodactyl project**, you can join the [Discord Chat](https://pterodactyl-installer.se/discord).
...
```bash
bash <(curl -s https://raw.githubusercontent.com/BoghosDavtyan/pterodactyl-installer/master/install.sh)
```
